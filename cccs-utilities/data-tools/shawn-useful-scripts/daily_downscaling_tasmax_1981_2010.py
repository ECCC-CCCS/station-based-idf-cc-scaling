...
fld1='tasmax_CanESM2_daily_1981to2010_raw.nc'
fld2='tasmax_CanESM2_daily_1981to2010_biasCorrected.nc'
fld3='tasmax_CanESM2_daily_1981to2010_qm_Celsius_Nicolas.nc'
fld4='tasmax_CanESM2_daily_1981to2010_BCCAQ2.nc'
fld5='tasmax_anusplin_daily_1981to2010_anusplin.nc'
...
var1 = (fh1['tasmax'].values).flatten()
var1=var1[:10950]

time2 = (fh2['time'].values).flatten()
var2 = (fh2['tasmax'].values).flatten()

time3 = (fh3['time'].values).flatten()
var3 = (fh3['tasmax'].values).flatten()

time4 = (fh4['time'].values).flatten()
var4 = (fh4['tasmax'].values).flatten()

time5 = (fh5['time'].values).flatten()
var5 = (fh5['tasmax'].values).flatten()
var5=var5[:10950]
...
ax.set_ylabel("Daily Maximum Temperature [$^\circ$C]",fontsize=font_size2)
...
legend6='Trend - GCM Raw Data- y=0.00018x + 14.558'
legend7='Trend - GCM Mean Bias Corrected- y=0.00016x + 10.558'
legend8='Trend - GCM Quantile Mapping- y=0.00014x + 10.690'
legend9='Trend - GCM BCCAQv2- y=0.00015x + 10.889'
legend10='Trend - Observations- y=0.00014x + 10.690'


#legend_col3 = ['y=0.00018x + 14.558','y=0.00016x + 10.558','y=0.00014x + 10.690','y=0.00015x + 10.889','y=0.00014x + 10.690']
...
lg.draw_frame(False)
plt.tight_layout()
plt.savefig(output +'trend_1981_2010_tasmax_obs_sdmethods3.png')
plt.plot()
